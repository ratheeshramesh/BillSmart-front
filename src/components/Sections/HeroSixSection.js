        ...
        <Row className={classes.row_content}>
          ...
          >
            <div className={`${classes.text_div} px-2`}>
              ...
              <p className={classes.text_location}>The Manager</p>
              <p className={classes.text_content}>
                With our meal, you can serve delectable, home-cooked
          ...
          >
            <div className={`${classes.text_div} px-2`}>
              ...
              <p className={classes.text_location}>Our client</p>
              <p className={classes.text_content}>
                No need to worry about any of this anymore with our app. Bill Smart 3.0 are made with the highest quality ingredients for you and
                your family.{" "}
              </p>
            </div>
          </Col>
